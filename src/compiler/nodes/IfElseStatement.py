...
class IfElseStatement(IfStatement):
    ...
    def generateCode(self, out):
        ...
        # Evaluate it
        self.writeInstruction("fjp if_" + str(IfStatement.label_counter) + "_false", out)
        
        # if the condition is true, execute the statement
        self.if_statement.generateCode(out)
        self.writeInstruction("ujp if_" + str(IfStatement.label_counter) + "_end", out)
        self.writeInstruction("if_" + str(IfStatement.label_counter) + "_false:", out)
