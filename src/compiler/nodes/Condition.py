...
class Condition(Expression):
    ...
    def __init__(self, ast, expr_disjunction, expression, expr_condition):
        ...
        operand_type = self.expression.result_type.getPoorest(self.condition.result_type)
    ...
    def generateCode(self, out):
        ...
        # evaluate it
        self.writeInstruction("fjp condition_" + str(Condition.label_counter) + "_false", out)
        ...
        self.writeInstruction("ujp condition_" + str(Condition.label_counter) + "_end", out)
        self.writeInstruction("condition_" + str(Condition.label_counter) + "_false:", out)
        ...
        self.writeInstruction("condition_" + str(Condition.label_counter) + "_end:", out)
